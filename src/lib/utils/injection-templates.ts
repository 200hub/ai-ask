    ...
    actions: [
      {
        type: "fill",
        selector:
          'rich-textarea .ql-editor, div[contenteditable="true"][aria-label*="输入"], div[contenteditable="true"][data-placeholder], textarea',
        content: "",
        triggerEvents: true,
        delay: 300,
        timeout: 5000,
      },
      {
        type: "click",
        selector:
          'button[aria-label*="发送"], button[aria-label*="Send"], button.send-button, button[type="submit"]',
        timeout: 3000,
      },
      {
        type: "extract",
    ...
    actions: [
      {
        type: "fill",
        selector:
          'textarea[placeholder*="Message"], textarea[placeholder*="消息"], div[contenteditable="true"]',
        content: "",
        triggerEvents: true,
        delay: 300,
        timeout: 5000,
    ...
    actions: [
      {
        type: "fill",
        selector:
          'textarea[placeholder*="输入"], textarea[placeholder*="Ask"], div[contenteditable="true"]',
        content: "",
        triggerEvents: true,
        delay: 300,
        timeout: 5000,
    ...
    actions: [
      {
        type: "fill",
        selector:
          'textarea[aria-label*="Source text"], textarea[aria-label*="源文本"], textarea.er8xn',
        content: "",
        triggerEvents: true,
        delay: 300,
        timeout: 5000,
    ...
    actions: [
      {
        type: "fill",
        selector:
          'textarea[data-testid="translator-source-input"], d-textarea[data-testid="translator-source-input"] textarea, div[contenteditable="true"][data-testid="translator-source-input"]',
        content: "",
        triggerEvents: true,
        delay: 300,
        timeout: 5000,
    ...
    actions: [
      {
        type: "fill",
        selector:
          'textarea.textarea-input-origin, #baidu_translate_input, textarea[placeholder*="请输入"]',
        content: "",
        triggerEvents: true,
        delay: 300,
        timeout: 5000,
