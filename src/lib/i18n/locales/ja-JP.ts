  ...
  settings: {
    ...
    general: {
        ...
        autoUpdate: "自動更新",
            ...
            selectionToolbarIgnoreDescription: "これらのアプリでは選択ツールバーを表示しません。プロセス名やウィンドウクラス名を入力してください（大文字小文字は区別されません）。",
            ...
            selectionToolbarDefaultPlatformDescription: "選択ツールバーの「説明」から使用するAIプラットフォーム（対応プラットフォームのみ表示）",
            selectPlatform: "プラットフォームを選択",
            selectionToolbarTemporaryDisableTitle: "一時的に無効化",
            selectionToolbarTemporaryDisableDescription: "デモや録画、集中作業などの際に選択ツールバーを一時的に停止します。",
    ...
    updateAvailableInline: "（{version} への更新が利用可能）",
        ...
        updateDownloadHint: "画面上部のアップデートバナーからダウンロードしてインストールしてください。",
        ...
        reportIssueDescription: "不具合や提案がありますか？上のボタンから GitHub Issue を作成してください。",
