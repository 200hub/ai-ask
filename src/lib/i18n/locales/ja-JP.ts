...
export const jaJP = {
    ...
    quickAsk: {
        ...
        cancel: "キャンセル",
        close: "閉じる",
        pasteFromClipboard: "クリップボードから貼り付けました",
        settingsTitle: "クイック質問設定",
        enabled: "クイック質問を有効化",
        enabledDescription: "グローバルショートカットで素早く質問",
        selectPlatform: "AI プラットフォームを選択",
        selectPlatformDescription: "クイック質問はこのプラットフォームで回答します",
        noPlatformSelected: "プラットフォーム未選択",
        selectPlatformPlaceholder: "AI プラットフォームを選択...",
        hotkeyLabel: "ホットキー時間窓",
        hotkeyDescription: "ホットキーのダブルプレス間隔（200-1000ミリ秒）",
        hotkeyHintLabel: "クイック質問ホットキー",
        hotkeyHintDescription: "デフォルト：Ctrl+Shift+Space（macOS：Cmd+Shift+Space）",
        voiceInputEnabled: "音声入力を有効化",
        voiceInputDescription: "音声で質問を入力できます（送信前に手動確認が必要）",
        errors: {
            noPlatform: "設定で AI プラットフォームを選択してください",
            emptyQuestion: "質問を入力してください",
            sendFailed: "送信に失敗しました。もう一度お試しください",
            platformNotEnabled: "選択されたプラットフォームが無効です",
            clipboardFailed: "クリップボードの読み取りに失敗しました",
            notLoggedIn: "未ログインです。ログインしてから再試行してください。",
        },
        goToLogin: "ログインへ移動",
    },
};
