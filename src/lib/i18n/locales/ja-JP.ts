...
export const jaJP = {
  ...
  settings: {
    ...
    proxy: 'プロキシ',
    translation: '翻訳',
    desktopNotes: 'デスクトップ付箋',
    about: 'について',
  },

  desktopNotes: {
    title: 'デスクトップ付箋',
    enabled: 'デスクトップ付箋を有効化',
    enabledDescription: '複数の独立した付箋ウィンドウをデスクトップに表示し、色・サイズ・位置・最前面を調整できます。',
    create: '付箋を作成',
    createDescription: '新しい Markdown 付箋を作成し、必要に応じてすぐにデスクトップへ表示します。',
    listTitle: '付箋一覧',
    empty: '付箋はまだありません。まずは 1 枚作成してみましょう。',
    untitled: '無題の付箋',
    emptyContent: 'この付箋はまだ空です。',
    open: '開く',
    delete: '削除',
    alwaysOnTop: '最前面',
    normalWindow: '通常ウィンドウ',
    windowTitle: 'デスクトップ付箋',
    titlePlaceholder: '付箋タイトルを入力',
    pin: '最前面',
    unpin: '最前面を解除',
    editor: '編集',
    preview: 'プレビュー',
    contentPlaceholder: 'ここに Markdown を入力…',
    changeColor: '色を変更',
    previewEmpty: 'ここにリアルタイムプレビューが表示されます。',
    notFound: '付箋が見つかりません',
    notFoundDescription: '削除されたか、ローカルデータの読み込みがまだ完了していない可能性があります。',
    loading: '付箋を読み込み中…',
    colors: {
      sunny: 'サニー',
      mint: 'ミント',
    ...
    auth: {
      account: '同期アカウント',
      accountDescription: 'メールアドレスとパスワードでサインインし、複数デバイスで付箋を同期します。',
      signIn: 'サインイン',
      signUp: 'サインアップ',
      signOut: 'サインアウト',
      signedInAs: '{email} としてサインイン済み',
      signedOut: 'サインアウトしました。',
      confirmEmail: '登録完了！確認メールをご確認ください。',
      emailPlaceholder: 'メールアドレスを入力',
      passwordPlaceholder: 'パスワードを入力',
      fillFields: 'メールアドレスとパスワードを入力してください。',
      passwordTooShort: 'パスワードは{min}文字以上で入力してください。',
      forgotPassword: 'パスワードをお忘れですか',
      resetEmailSent: 'パスワードリセットメールを送信しました。',
      enterEmail: 'まずメールアドレスを入力してください。',
    },
    sync: {
      title: 'クラウド同期',
      enabled: '同期を有効化',
      enabledDescription: '付箋をクラウドに同期し、複数デバイスで利用できます。',
      now: '今すぐ同期',
      syncing: '同期中…',
      lastSyncedAt: '最終同期',
      never: '未同期',
      successCount: '同期完了: {pushed} 件送信、{pulled} 件受信',
      autoSyncSuccess: '同期済み',
      autoSyncError: '同期失敗',
    },
  },
