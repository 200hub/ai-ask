...
export const enUS = {
  ...
  desktopNotes: {
    title: 'Desktop Notes',
    enabled: 'Enable desktop notes',
    enabledDescription: 'Show multiple standalone sticky-note windows on the desktop with color, size, position, and pin control.',
    create: 'Create note',
    createDescription: 'Create a new Markdown note and optionally show it on the desktop immediately.',
    listTitle: 'Notes',
    empty: 'No notes yet — time to uncap the digital sticky stack.',
    untitled: 'Untitled note',
    emptyContent: 'This note is still blank.',
    open: 'Open',
    delete: 'Delete',
    alwaysOnTop: 'Pinned',
    normalWindow: 'Normal window',
    windowTitle: 'Desktop Note',
    ...
    previewEmpty: 'Live preview appears here.',
    notFound: 'Note not found',
    notFoundDescription: 'The note may have been removed, or local data has not finished loading yet.',
    ...
    auth: {
      ...
      accountDescription: 'Sign in with email and password to sync notes across devices.',
      signIn: 'Sign in',
      signUp: 'Sign up',
      signOut: 'Sign out',
      signedInAs: 'Signed in as {email}',
      signedOut: 'Signed out.',
      confirmEmail: 'Sign-up complete! Please check your email to confirm your account.',
    ...
    sync: {
      title: 'Cloud Sync',
      enabled: 'Enable sync',
      enabledDescription: 'Sync notes to the cloud for multi-device access.',
      now: 'Sync now',
      syncing: 'Syncing…',
      lastSyncedAt: 'Last synced',
      never: 'Never synced',
      successCount: 'Sync complete: {pushed} pushed, {pulled} pulled',
      autoSyncSuccess: 'Synced',
      autoSyncError: 'Sync failed',
    },
  },
