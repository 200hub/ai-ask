...
export const enUS = {
    ...
    quickAsk: {
        ...
        cancel: "Cancel",
        close: "Close",
        pasteFromClipboard: "Pasted from clipboard",
        settingsTitle: "Quick Ask Settings",
        enabled: "Enable Quick Ask",
        enabledDescription: "Use global shortcut to ask questions quickly",
        selectPlatform: "Select AI Platform",
        selectPlatformDescription: "Quick Ask will use this platform to answer questions",
        noPlatformSelected: "No platform selected",
        selectPlatformPlaceholder: "Select an AI platform...",
        hotkeyLabel: "Hotkey Time Window",
        hotkeyDescription: "Double-press interval for hotkey (200-1000ms)",
        hotkeyHintLabel: "Quick Ask Hotkey",
        hotkeyHintDescription: "Default: Ctrl+Shift+Space (macOS: Cmd+Shift+Space)",
        voiceInputEnabled: "Enable Voice Input",
        voiceInputDescription: "Allow voice input for questions (requires manual confirmation before sending)",
        errors: {
            noPlatform: "Please select an AI platform in settings first",
            emptyQuestion: "Question cannot be empty",
            sendFailed: "Failed to send, please try again",
            platformNotEnabled: "Selected platform is not enabled",
            clipboardFailed: "Failed to read clipboard",
            notLoggedIn: "You're not signed in. Please sign in and try again.",
        },
