...
export const enUS = {
    ...
    general: {
        ...
        selectionToolbarDescription: "Show translation and AI explanation buttons when selecting text in any app",
        selectionToolbarIgnoreTitle: "Ignored Applications",
        selectionToolbarIgnoreDescription: "Do not show the selection toolbar in these apps. Enter process names or window class names (case-insensitive).",
        ...
        accessibilityPermissionMessage: "The cross-app selection feature requires accessibility permissions to work properly. Click the button below to open System Settings, then add this app in 'Privacy & Security > Accessibility'.",
        openSystemSettings: "Open System Settings",
        recheckPermission: "Recheck Permission",
        selectionToolbarDefaultPlatform: "Default Selection Toolbar AI",
        selectionToolbarDefaultPlatformDescription: "AI platform used when triggering Explain from the selection toolbar (only toolbar-ready platforms are listed)",
        selectPlatform: "Select Platform",
        selectionToolbarTemporaryDisableTitle: "Temporary Disable",
        selectionToolbarTemporaryDisableDescription: "Temporarily stop the selection toolbar, useful for demos, recording, or focused work.",
        ...
        preloadPlatformsDescription: "Preload default translation and AI platforms in the background during startup for faster first use",
