...
export const koKR = {
    ...
    quickAsk: {
        ...
        cancel: "취소",
        close: "닫기",
        pasteFromClipboard: "클립보드에서 붙여넣기 완료",
        settingsTitle: "빠른 질문 설정",
        enabled: "빠른 질문 활성화",
        enabledDescription: "글로벌 단축키로 빠르게 질문하기",
        selectPlatform: "AI 플랫폼 선택",
        selectPlatformDescription: "빠른 질문이 이 플랫폼을 사용해 답변합니다",
        noPlatformSelected: "플랫폼 미선택",
        selectPlatformPlaceholder: "AI 플랫폼을 선택하세요...",
        hotkeyLabel: "단축키 시간 창",
        hotkeyDescription: "단축키 이중 누르기 간격 (200-1000ms)",
        hotkeyHintLabel: "빠른 질문 단축키",
        hotkeyHintDescription: "기본값: Ctrl+Shift+Space (macOS: Cmd+Shift+Space)",
        voiceInputEnabled: "음성 입력 활성화",
        voiceInputDescription: "음성으로 질문 입력 가능 (전송 전 수동 확인 필요)",
        errors: {
            noPlatform: "설정에서 AI 플랫폼을 먼저 선택하세요",
            emptyQuestion: "질문을 입력해야 합니다",
            sendFailed: "전송 실패, 다시 시도하세요",
            platformNotEnabled: "선택된 플랫폼이 비활성화되어 있습니다",
            clipboardFailed: "클립보드 읽기 실패",
            notLoggedIn: "로그인되지 않았습니다. 로그인 후 다시 시도하세요.",
        },
        goToLogin: "로그인하러 가기",
    },
};
